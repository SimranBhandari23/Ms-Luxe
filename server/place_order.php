...
// if user is logged in
    ...
    //4.store each single item in order_items database
        ...
        //5.remove everything from cart & checkout session data
        unset($_SESSION['cart']);
        $_SESSION['total'] = 0;
        unset($_SESSION['checkout']);

        //6.inform user that order was placed successfully
        header('location:../account.php?order_success=Order placed successfully');
